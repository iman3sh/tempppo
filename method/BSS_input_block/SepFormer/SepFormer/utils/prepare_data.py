...
def create_custom_dataset(
    ...
    for set_type in set_types:
        ...
        files = [x for x in files if x.split('.')[-1]=='wav']
...
if __name__=='__main__':
    Datapath = '/home/iman/storage/code/project/PERSONAL/military/GIT/github_repos/speechbrain/samples/audio_samples/BSS_8kHz'
    savepath = '/home/iman/storage/code/project/PERSONAL/military/GIT/github_repos/speechbrain/recipes/WSJ0Mix/separation/train_csv_files'
    prepare_wsjmix(Datapath,
                   savepath,
                   n_spks=2)
